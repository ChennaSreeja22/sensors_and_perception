...
class ImageSubscriber(Node):
    ...
    def process_image(self, img):
        ...
        if len(contours) > 0:
            ...
            # Make sure that "m00" won't cause ZeroDivisionError
            if M["m00"] != 0:
                cx = int(M["m10"] / M["m00"])
                cy = int(M["m01"] / M["m00"])
            else:
            ...
            # Stop if the ball is very close
            if area > 25000:
    ...
    def add_small_pictures(self, img, small_images, size=(60, 45)):
